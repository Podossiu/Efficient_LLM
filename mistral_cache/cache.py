...
if __name__ == "__main__":
    l1 = [torch.arange(1, 10), torch.arange(2, 10)]
    l2 = [torch.arange(3, 10), torch.arange(4, 10)]
    
    cache = RotatingBufferCache(12, 8, 3, 2, 32)
    cache_view = cache.get_input_metadata([5, 7, 2])
    print(cache_view)
