...
class _LayerNorm(torch.autograd.Function):
    ...
    def forward(
        ...
        assert inp.is_cuda, "This module only for GPUs(CUDA)."
...
class LayerNorm(torch.nn.Module):
    """https://github.com/NVIDIA/TransformerEngine/blob/fad3044bde1547eae9543a6a3f80401e59bb629e/transformer_engine/pytorch/module/layernorm.py"""
    r"""
    ...
    def __init__(
        ...
        def forward(self, inp: torch.Tensor) -> torch.Tensor:
            """LayerNorm FWD"""
            # grad에 따라서 argument에 none이 발생? + forward만 추가 
            # None : ctx part
